...
public class ProductController {
    ...
    public List<Product> getProductsByType(@RequestBody Product product) {
        return service.getProductsByType(product);
    }

    @PatchMapping("/{id}")
    public Product updateProductsByField(@PathVariable int id, @RequestBody Map<String, Object> fields) {
        return service.updateProductsByField(id, fields);
    }
